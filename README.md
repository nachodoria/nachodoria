...
- **Languages:** JavaScript, CSS, HTML5, XML, Java, C  
- **Frameworks & Libraries:** ReactJS, NextJS, NextUI, Framer Motion, ThreeJS  
...
### 🌐 [Personal Portfolio (2024)](https://ignacio-doria.vercel.app/)
Designed and developed a portfolio website to showcase my projects, skills, and contact info.  
**Technologies:** NextJS, Framer Motion, Observer API, NextUI  
...
### 🌀 Golden Portal (2022)
Created a 3D portal in Blender and integrated it into a responsive website.  
**Technologies:** ThreeJS, Blender  

### 🌌 Galaxy Generator (2022)
Interactive galaxy generator exploring ThreeJS properties with customizable star density, colors, and animations.  
